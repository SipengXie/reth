    ...
    H: HashedCursorFactory + Clone,
{
    ...
    #[tracing::instrument(level = "info", name = "multiproof_inner", skip_all)]
    pub fn multiproof(
        mut self,
        ...
        let top_span = info_span!("trie_iter");
        let enter = top_span.enter();
    ...
    H: HashedCursorFactory,
{
    ...
    #[tracing::instrument(level = "info", name = "storage_multiproof_inner", skip_all)]
