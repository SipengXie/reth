...
pub static ALTIUS: LazyLock<Arc<ChainSpec>> = LazyLock::new(|| {
    let genesis = serde_json::from_str(include_str!("../res/genesis/altius.json"))
        .expect("Can't deserialize Altius genesis json");
    let hardforks = DEV_HARDFORKS.clone();
    let ALTIUS_GENESIS_HASH: B256 = b256!("0xa08e4b02d455d6385e273fd1d3424a6efb74b357d8a982828f0f9db7fe6e4664");
    ChainSpec {
        chain: Chain::dev(),
        genesis_header: SealedHeader::new(
            make_genesis_header(&genesis, &hardforks),
